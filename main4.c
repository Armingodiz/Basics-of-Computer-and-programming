...
int save_game(FILE *save1, FILE *save2, struct cell *header,int number_of_cells,struct block map[40][40]);
...
int save_game(FILE *save1, FILE *save2, struct cell *header,int number_of_cells,struct block map[n][n])
{
